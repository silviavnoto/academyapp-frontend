...
@Component({
  selector: 'app-usuario.alumno.plist',
  templateUrl: './alumno.plist.component.html',
  styleUrls: ['./alumno.plist.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule, TrimPipe, RouterModule],
})
export class AlumnoPlistComponent implements OnInit {
